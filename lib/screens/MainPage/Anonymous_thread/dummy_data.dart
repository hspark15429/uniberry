class Post {
  ...
  final int viewCount;
  final int likesCount; // 좋아요 수 필드 추가
  final List<Comment> comments; // 댓글 목록 필드 추가
   ...
   Post({
    ...
    this.likesCount = 0, // 기본값 설정
    this.comments = const [], // 기본값 설정
  });
}
...
final List<Post> dummyPosts = [
  ...
  Post(
    ...
    imageUrls: ['https://image.gaxi.jp/article_1646718701418.png', 'https://image.gaxi.jp/article_1646673784650.png',
    'https://image.gaxi.jp/article_1646673791518.png', 'https://image.gaxi.jp/article_1646673803846.png'],
    boardType: BoardType.scholarship,
    commentCount: 10,
    datePosted: '2024-03-11',
    viewCount: 500,
    likesCount: 120, // 좋아요 수 예시
    comments: [
Comment(
  id: 1,
...
Comment(
  ...
  Post(
    ...
    Post(
      ...
      title: 'スタートアップイベント情報',
      content:
          '新たなビジネスチャンスを見つけるためのイベントが開催されます。興味のある方はぜひご参加ください。',
      imageUrls: [],
      boardType: BoardType.entrepreneurship,
      commentCount: 12,
    ...
    Post(
      ...
      content:
          '起業家になるためのスキルを磨くためのセミナーが行われます。参加することで新たなアイデアを得るチャンスです。',
      imageUrls: [],
      boardType: BoardType.entrepreneurship,
      commentCount: 8,
